...
"https://firestore.googleapis.com/v1/projects/xw2218-dash/databases/(default)/documents/xw2218:listCollectionIds?&key=AIzaSyAK0__HouR0MWQj2EYNOkrlkQuc1LDNXW0" \
-o list-collectionid.txt

cat list-collectionid.txt
